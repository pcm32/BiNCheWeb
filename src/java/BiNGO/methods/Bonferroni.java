...
public class Bonferroni implements CalculateCorrectionTask {
    ...
    public Bonferroni(HashMap golabelstopvalues, String alpha) {
        ...
        Bonferroni.goLabels = goLabels;
        Bonferroni.alpha = new BigDecimal(alpha);
        Bonferroni.m = pvalues.length;
        Bonferroni.adjustedPvalues = new String[m];
        Bonferroni.correctionMap = null;
    ...
    public void calculate() {
        ...
        Bonferroni.ordenedPvalues = parse(hash);
