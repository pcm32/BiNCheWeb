...
public class BinomialTestCalculate implements CalculateTestTask {
    ...
    public BinomialTestCalculate(DistributionCount dc) {
        ...
        dc.calculate();
        BinomialTestCalculate.mapSmallN = dc.getMapSmallN();
        BinomialTestCalculate.mapSmallX = dc.getMapSmallX();
        BinomialTestCalculate.mapBigN = dc.getMapBigN();
        BinomialTestCalculate.mapBigX = dc.getMapBigX();
