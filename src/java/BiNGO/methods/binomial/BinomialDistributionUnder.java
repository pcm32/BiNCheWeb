...
public class BinomialDistributionUnder {
    ...
    public BinomialDistributionUnder(int x, int bigX, int n, int bigN) {
        BinomialDistributionUnder.x = x;
        BinomialDistributionUnder.bigX = bigX;
        BinomialDistributionUnder.n = n;
        BinomialDistributionUnder.bigN = bigN;
		BinomialDistributionUnder.p = n*1.0/bigN;
    }
