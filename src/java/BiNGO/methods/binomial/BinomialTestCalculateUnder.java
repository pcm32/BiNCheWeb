...
public class BinomialTestCalculateUnder implements CalculateTestTask {
    ...
    public BinomialTestCalculateUnder(DistributionCount dc) {
        ...
        dc.calculate();
        BinomialTestCalculateUnder.mapSmallN = dc.getMapSmallN();
        BinomialTestCalculateUnder.mapSmallX = dc.getMapSmallX();
        BinomialTestCalculateUnder.mapBigN = dc.getMapBigN();
        BinomialTestCalculateUnder.mapBigX = dc.getMapBigX();
