...
public class BenjaminiHochbergFDR implements CalculateCorrectionTask {
    ...
    public BenjaminiHochbergFDR(HashMap golabelstopvalues, String alpha) {
        ...
        BenjaminiHochbergFDR.m = pvalues.length;
        BenjaminiHochbergFDR.adjustedPvalues = new String[m];
        BenjaminiHochbergFDR.correctionMap = null;
    ...
    public void calculate() {
        ...
        BenjaminiHochbergFDR.ordenedPvalues = parse(hash);
