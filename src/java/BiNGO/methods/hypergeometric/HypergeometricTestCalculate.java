...
public class HypergeometricTestCalculate implements CalculateTestTask {
    ...
    public HypergeometricTestCalculate(DistributionCount dc) {
        ...
        dc.calculate();
        HypergeometricTestCalculate.mapSmallN = dc.getMapSmallN();
        HypergeometricTestCalculate.mapSmallX = dc.getMapSmallX();
        HypergeometricTestCalculate.mapBigN = dc.getMapBigN();
        HypergeometricTestCalculate.mapBigX = dc.getMapBigX();
