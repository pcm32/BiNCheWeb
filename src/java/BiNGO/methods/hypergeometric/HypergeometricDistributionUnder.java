...
public class HypergeometricDistributionUnder {
    ...
    public HypergeometricDistributionUnder(int x, int bigX, int n, int bigN) {
        HypergeometricDistributionUnder.x = x;
        HypergeometricDistributionUnder.bigX = bigX;
        HypergeometricDistributionUnder.n = n;
        HypergeometricDistributionUnder.bigN = bigN;
    }
