                    ...
                    <div style="padding: 5px" class="type-selection">
                        ...
                        <span id="weightInfo" style="display: none; padding: 2px; font-size: 10.5pt; height: 70px; text-align: left; margin-left: 3.5em">
                            <p>This analysis accepts a list of ChEBI ids and their weights. <br>
                                Weight is a decimal value between 0 and 1.<br> </p>
                        ...
                        <span id="fragmentInfo" style="display: none; padding: 2px; height: 70px; text-align: left; margin-left: 3em">
                            <p style="font-size: 10.5pt">This method accepts a list of ChEBI ids and their weights. <br>                         
